const data = [
    {
        ...
        desc: "a blood bank management website using python is a web-based system that allows blood banks to manage their inventory,donors,and recipients efficiently",
        tech:[{stack:"python"},  {stack:"django"},  {stack:"bootstrap"},  {stack:"html,css"}],
    },
    {
        title: "library management system",
        sorce: "https://github.com/Anfas-Mp",
        desc: "A library management website using PHP is a web-based system that automates the library's daily operations, such as book cataloging, lending, fine calculation.",
        tech:[{stack:"php"}, {stack:"mysql"},  {stack:"bootstrap"},  {stack:"html,css"}],
    },
    {
        title: "office management system",
        sorce: "https://github.com/Anfas-Mp/officeproject",
        desc: "office management website using Python is a web-based system that streamlines employee and project management, task allocation, file sharing, communication tools.",
        tech:[{stack:"python"}, {stack:"django"},  {stack:"bootstrap"},  {stack:"html,css"}],
    },
    {
